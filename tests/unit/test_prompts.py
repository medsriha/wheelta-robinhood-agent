...
def test_unused_value_aborts() -> None:
    with pytest.raises(PromptError, match="unused values \\['extra'\\]"):
        render_prompt(load_prompt(), _values(V5_PLACEHOLDERS | {"extra"}))
